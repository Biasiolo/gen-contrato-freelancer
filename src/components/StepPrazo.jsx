      ...
      <div className="relative max-w-4xl w-full mx-auto">
        <div className="relative backdrop-blur-sm bg-white/5 border border-teal-700/40 rounded-lg p-10 overflow-auto">
          ...
          <div className="mt-10 flex flex-col md:flex-row justify-between gap-4">
            <button
              onClick={onBack}
              className="group relative cursor-pointer flex items-center justify-center w-full md:w-40 overflow-hidden rounded-3xl bg-neutral-800 py-2 text-white shadow-lg transition-all hover:shadow-neutral-700/25"
            >
