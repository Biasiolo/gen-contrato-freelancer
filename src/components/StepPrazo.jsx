    ...
    <div className="relative max-w-4xl w-full mx-auto">
      <div className="relative backdrop-blur-sm bg-white/5 border border-teal-700/40 rounded-lg p-10 overflow-auto">
                      ...
                      {svc.isMonthly && (
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                          ...
                          <select
                            ...
                            className="px-3 py-2 bg-stone-200 bg-opacity-20 text-white rounded-xl focus:ring-2 focus:ring-teal-600 border-none"
                          >
                            {[...Array(12)].map((_, i) => (
        ...
        <div className="mt-10 flex flex-col md:flex-row justify-between gap-4">
          <button
            onClick={onBack}
            className="group relative flex items-center justify-center w-full md:w-40 overflow-hidden rounded-3xl bg-neutral-800 py-2 text-white shadow-lg transition-all hover:shadow-neutral-700/25"
          >
          ...
          <button
            onClick={onNext}
            className="group relative flex items-center justify-center w-full md:w-40 overflow-hidden rounded-3xl bg-gradient-to-r from-teal-600 to-teal-600 py-2 text-white shadow-lg transition-all hover:shadow-orange-500/25"
          >
