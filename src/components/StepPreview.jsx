            ...
            <section key={type.id} className="space-y-4 mb-8">
                    ...
                    {list.map(item => (
                      <React.Fragment key={item.id}>
                        <tr>
                          ...
                          <td className="border px-2 py-1 text-right text-gray-800">{formatCurrency(item.unitValue)}</td>
                          <td className="border px-2 py-1 text-right text-gray-800">{formatCurrency(item.subtotal)}</td>
                        </tr>
                        {item.description && (
                          <tr>
              ...
              <div className="bg-gray-200 p-2 pt-2 rounded-b-3xl">
                ...
                <div className="flex flex-col sm:flex-row sm:space-x-6 text-gray-700 mb-2 justify-center items-center gap-1">
                  ...
                  <span><strong>Entrada:</strong> {formatCurrency(entrada)}</span>
                  <span>
