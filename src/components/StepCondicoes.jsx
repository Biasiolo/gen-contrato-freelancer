      ...
      <div className="relative backdrop-blur-sm bg-white/5 border border-teal-700/40 rounded-lg p-10 overflow-auto">
        ...
        <div className="space-y-8">
          {servicesCatalog.serviceTypes.map(type => {
            ...
            return (
              <section key={type.id}>
                <h3 className="text-xl text-center font-semibold text-neutral-100 mb-2 bg-black rounded-t-3xl p-2">
                ...
                <div className="space-y-4 px-2 pb-2">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-neutral-100 mb-1">Parcelas (Saldo)</label>
                      <input
                        type="number"
                        min="1"
                        className="w-full px-3 py-2 bg-stone-200 bg-opacity-20 text-gray-900 rounded-xl focus:ring-2 focus:ring-teal-600 placeholder-gray-600 placeholder-opacity-60"
