...
import { nextTermo, prevTermo, goToTermoStep, resetTermoForm } from "@/store/termo";
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
          ...
          {labels.map((label, i) => {
            ...
            return (
              <li key={label} className="flex flex-col items-center gap-2">
                <button
                  onClick={() => dispatch(goToTermoStep(i))}
        ...
        {/* BARRA DE PROGRESSO + REINICIAR (igual ao contrato) */}
        <div className="flex items-center gap-3">
